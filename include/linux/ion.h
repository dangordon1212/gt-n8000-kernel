...
enum ion_heap_type {
	...
	ION_HEAP_TYPE_EXYNOS_CONTIG = 4,
	ION_HEAP_TYPE_EXYNOS,
	ION_HEAP_TYPE_EXYNOS_USER,
#endif
	// FIXME! the new ION_HEAP_TYPE_CHUNK has to come after the EXYNOS heap types
	// 'till Samsung releases new ROM to reflect upstream ION changes
	ION_HEAP_TYPE_CHUNK,
	ION_HEAP_TYPE_DMA,
...
/**
 * struct ion_allocation_data_old - metadata passed from userspace for allocations (legacy)
 * @len:		size of the allocation
...
/**
 * DOC: ION_IOC_ALLOC_OLD - allocate memory (legacy)
 *
